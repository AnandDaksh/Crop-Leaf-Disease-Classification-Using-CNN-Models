...
# Define classes
classes = ["Blueberry___healthy","Cherry___healthy","Cherry___Powdery_mildew"]

# Define the path to the folder containing the images
data_dir = "E:/Nikhil/Daksh/Datasets/Blueberry_Cherry_Datasets"
...
datagen = tf.keras.preprocessing.image.ImageDataGenerator(
    ...
    validation_split=0.3  # Splitting the data into training and validation sets
)
...
# Save the model
model.save("Blueberry_Cherry.h5")
print("Model saved successfully as Blueberry_Cherry.h5")
